...
public WebDriver initializeDriver() throws IOException {
	...
	FileInputStream fis = new FileInputStream(basePath + "/src/main/java/rahulshettyacademy/resources/GlobalData1.properties");
//System.getProperty(System.getProperty("user.dir")+
   ...
   // String browserName = prop.getProperty("browser");
    ...
    if (browserName == null) {
        throw new RuntimeException("Browser name not specified in the properties file.");
    }
